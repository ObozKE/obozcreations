...
export const metadata: Metadata = {
  ...
  description: "Learn about BoldCreations, a Nairobi-based creative studio founded by cinematographer Martin Oduor, specializing in film, commercial videography, and photography.",
  openGraph: {
    title: "About BoldCreations Studio",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-6">
            ...
            <p className="font-body text-base md:text-lg text-muted-cream leading-relaxed max-w-xl">
              BoldCreations is an independent videography, photography, and cinematography studio based in Nairobi, Kenya. Founded by Martin Oduor, we translate ideas, events, and brand visions into compelling visual cinema.
            </p>
          </div>
        ...
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="font-body text-sm md:text-base text-muted-cream space-y-4 leading-relaxed">
              <p>
                Founded in Nairobi, BoldCreations was built on a passion for authentic African storytelling. We believe every couple, brand, musician, and community has a distinct visual rhythm waiting to be unearthed.
              </p>
              <p>
